  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="ghost" className="group-data-[sidebar-color=black]:group-data-[slider=top]:hover:bg-slate-700">
          <Settings className="animate-[spin_3s_linear_infinite] group-data-[sidebar-color=black]:group-data-[slider=top]:text-slate-500 size-5" />
        </Button>
      </SheetTrigger>
      <SheetContent
