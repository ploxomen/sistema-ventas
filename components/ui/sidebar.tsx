...
function SidebarProvider({
  ...
  let classPositionsidebar = "";
  if (positionSidebar === "left") {
    classPositionsidebar = "flex-row-reverse";
  } else if (positionSidebar === "top") {
    classPositionsidebar = "flex-col";
  }
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          className,
          "group-data-[color=black]:border-slate-700",
        )}
        {...props}
      >
        <div
...
function SidebarTrigger({
  ...
  const { positionSidebar } = usePositionSidebar();
  if (positionSidebar === "top") return null;
  return (
    <Button
...
function SidebarInset({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-inherit relative flex w-full flex-col",
